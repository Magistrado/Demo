...
class DBAccess(DBHandler):
    ...
    def __init__(self, cat_base):
        self.subcomp_class = self.get_subcomponent_class()
        self.part_number, self.manufacturer, self.origin = \
            self.get_create_prods_attrib(self.subcomp_class)
    ...
    def get_subcomponent_class(self):
        subclass = self.get_create_prod_class('Subcomponent')
    ...
    def get_create_prod_class(self, nom):
